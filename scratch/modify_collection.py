...
try:
    ...
    # 4. Update Reset Shop/Filter button
    content = content.replace("bg-green-600 text-white font-bold px-6 py-2.5 rounded-xl text-xs hover:bg-green-700 transition", "btn-primary-custom font-bold px-6 py-2.5 rounded-xl text-xs transition")
    
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(content)
        
    print("Successfully modified collection.blade.php")

except Exception as e:
    print(f"Error modifying collection: {e}")
